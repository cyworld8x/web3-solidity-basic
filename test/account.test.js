...
describe('Account Contract', () => {
    ...
    before(async () => {
        ...
        const accountContract = new web3.eth.Contract(Account.abi);
        
        accountInstance = await accountContract.deploy({
            data: Account.evm.bytecode.object,
          }).send({ from: accounts[0], gas: '1000000' });
    });

    it('deploy a account contract', async () => {
